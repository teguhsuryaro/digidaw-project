        ...
        <section className="bg-surface-container-lowest p-8 rounded-xl shadow-[var(--shadow-ambient)]">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              <img className="w-20 h-20 rounded-lg object-cover" alt="Donut" src="https://images.unsplash.com/photo-1551024601-bec78aea704b?auto=format&fit=crop&w=200&q=80" referrerPolicy="no-referrer" />
              <div className="flex-grow">
                <div className="flex justify-between">
                  <h3 className="font-bold text-on-surface">Artisan Glazed Donut</h3>
                  <span className="font-bold">Rp 15.000</span>
                </div>
                <p className="text-sm text-on-surface-variant mt-1">Varian: Strawberry Sparkle</p>
                <p className="text-sm font-medium mt-1">Qty: 2</p>
              </div>
            </div>
            {/* Item 2 */}
            <div className="flex gap-4">
              <img className="w-20 h-20 rounded-lg object-cover" alt="Coffee" src="https://images.unsplash.com/photo-1461023058943-07fcbe16d735?auto=format&fit=crop&w=200&q=80" referrerPolicy="no-referrer" />
              <div className="flex-grow">
                <div className="flex justify-between">
                  <h3 className="font-bold text-on-surface">Cold Brew Signature</h3>
                  <span className="font-bold">Rp 28.000</span>
                </div>
                <p className="text-sm text-on-surface-variant mt-1">Varian: Less Sugar</p>
          ...
          <div className="mt-8 pt-6 border-t border-outline-variant space-y-3">
            ...
            <div className="flex justify-between items-center pt-2">
              ...
              <span className="text-2xl font-black text-primary headline">Rp 60.000</span>
            </div>
          </div>
        </section>
      </div>
      ...
      <div className="lg:col-span-5 space-y-8">
        <section className="bg-surface-container-lowest p-8 rounded-xl shadow-[var(--shadow-ambient)] sticky top-24">
          ...
          <div className="p-4 rounded-xl bg-primary-fixed border border-primary/20 flex items-center justify-between mb-8 cursor-pointer">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 bg-white rounded-lg flex items-center justify-center shadow-sm">
                 <img className="w-8 h-8 object-contain" alt="QRIS" src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a2/Logo_QRIS.svg/1200px-Logo_QRIS.svg.png" referrerPolicy="no-referrer" />
              </div>
              <div>
          ...
          <div className="flex flex-col items-center">
            ...
            <button className="w-full bg-gradient-to-r from-primary to-primary-container text-on-primary py-4 rounded-lg font-bold text-lg shadow-lg hover:opacity-90 transition-all flex items-center justify-center gap-2 cursor-pointer">
